...
def match_fun(function1, function2):
    ...
    for i in range(min_len):
        if (function1_simplified_list[i] == function2_simplified_list[i] and function1_simplified_list[i] != " "):
            sameNum += 1
    return 2 * sameNum / (len(function1_simplified_list) + len(function2_simplified_list)),str(function1_simplified),str(function2_simplified)
